    ...
    <div id="pcoded" class="pcoded">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <button class="btn btn-primary" onclick="checkExamStatus()">Check Status</button>
                <div id="result"></div>
            </div>
        </div>
    </div>
...
<![endif]-->
    ...
    <script>
        function checkExamStatus() {
            ...
            // Simulate fetching attendance percentage from server
            var attendancePercentage = Math.floor(Math.random() * 101); // Random percentage between 0 and 100

            // Display exam status based on attendance percentage
            var resultDiv = document.getElementById("result");
            if (attendancePercentage >= 75) {
                resultDiv.innerHTML = `<p>Your attendance percentage for ${course} is ${attendancePercentage}%. You are qualified for exams.</p>`;
            } else {
                resultDiv.innerHTML = `<p>Your attendance percentage for ${course} is ${attendancePercentage}%. You are not qualified for exams.</p>`;
            }
        }
    </script>
</body>
