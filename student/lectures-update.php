                    ...
                    while ($row = mysqli_fetch_assoc($selecting_courses_allocated)) {
                        ...
                        while ($row = mysqli_fetch_assoc($selecting_classes)) {
                            ...
                            <div class="lecture-card">
                                <h5>Course Update: '.$course_code.'</h5>
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#courseDetailsModal'.$class_id.'">
                                    View Details
                                </button>
                            </div>          

                            <!-- Course Details Modal -->
    <div class="modal fade" id="courseDetailsModal'.$class_id.'" tabindex="-1" role="dialog" aria-labelledby="courseDetailsModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="courseDetailsModalLabel">Course Update: '.$course_code.'</h5>
                ...
                <div class="modal-body">
                    ...
                    <p><strong>Lecturer:</strong>'.$fullname.'</p>
