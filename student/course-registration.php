...
<body>
            ...
            <form>
                <div class="form-group">
                    ...
                    <select class="form-control" id="course">
                        ...
                        <option>CMP 415</option>
                        <option>CMP 410</option>
    ...
    <div class="registered-courses mb-5">
...
document.addEventListener("DOMContentLoaded", function() {
    function addCourseEntry(courseCode, courseTitle) {
        ...
        courseDetails.textContent = courseCode + " - " + courseTitle;

        var unregisterBtn = document.createElement("button");
        unregisterBtn.classList.add("btn", "btn-danger", "unregister-btn");
        unregisterBtn.textContent = "Unregister";

        courseEntry.appendChild(courseDetails);
        courseEntry.appendChild(unregisterBtn);

        var registeredCourses = document.querySelector(".registered-courses");
        registeredCourses.appendChild(courseEntry);
    }

    addCourseEntry("CMP 411", "Introduction to Computer Science");

    function handleUnregisterBtnClick(event) {
        var courseEntry = event.target.closest(".course-entry");
        courseEntry.remove();
    }

    document.addEventListener("click", function(event) {
        if (event.target.classList.contains("unregister-btn")) {
            handleUnregisterBtnClick(event);
        }
    });
});
</script>
