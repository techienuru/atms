                        ...
                        <div class="pcoded-inner-content">
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    <!-- Page-body start -->
                                    <div class="page-body" style="text-decoration: none !important;">
                                        <div class="card dashboard-card course-update">
    <div class="card-header bg-primary text-white">
        <h5 class="card-title mb-0 text-white">Personal Details</h5>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-4 order-md-2">
                <div class="text-center">
                    <div id="avatar-container">
                        <img src="placeholder_avatar.png" alt="Avatar" class="avatar img-fluid" id="avatar-img">
                    </div>
                </div>
            </div>
            <div class="col-md-8 order-md-1 personal-details">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="fullname">Full Name:</label>
                            <p id="fullname" class="form-control-static"><?php echo $fullname; ?></p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="matricno">Email:</label>
                            <p id="matricno" class="form-control-static"><?php echo $email; ?></p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <p id="matricno" class="form-control-static"><?php echo $faculty; ?></p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <p id="matricno" class="form-control-static"><?php echo $department; ?></p>
                        </div>
                    </div>
                </div>
            </div>
